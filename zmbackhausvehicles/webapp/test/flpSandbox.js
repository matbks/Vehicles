		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Veículos",
									"targetURL": "#vehicleszmbackhausvehicles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vehicleszmbackhausvehicles-display": {
								"semanticObject": "vehicleszmbackhausvehicles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vehicles.zmbackhausvehicles",
									"url": sap.ui.require.toUrl("vehicles/zmbackhausvehicles")
								}
							}
						}
					}
